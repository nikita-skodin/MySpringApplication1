...
@Configuration
@ComponentScan("com.skodin")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("com.skodin.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(Objects.requireNonNull(enviroment.getProperty("hibernate.driver_class")));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.skodin.models");
